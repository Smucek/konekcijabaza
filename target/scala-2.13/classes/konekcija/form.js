    ...
    $(document).on("click", ".editbtn", function() {
     ...
     $('.table tbody').on('click', '.confirmbtn', function() {
         ...
         var editedVehicleData = {
            ...
            "plate" : $(currentTD).parents("tr").find(".plate").text(),
            "category" : $(currentTD).parents("tr").find(".category").text(),
            "registration_date" : $(currentTD).parents("tr").find(".registration_date").text(),
            "registration_end_date" : $(currentTD).parents("tr").find(".registration_end_date").text()
         };
